...
public class DishHomeAdapter  extends RecyclerView.Adapter<DishHomeAdapter.DishHomeViewHolder> {
    ...
    public DishHomeAdapter(Context context, List<Dish> dishList, OnItemClickListener listener, int id) {
    ...
    @NonNull
    @Override
    public DishHomeAdapter.DishHomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_food_in_home, parent, false);
        return new DishHomeAdapter.DishHomeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DishHomeAdapter.DishHomeViewHolder holder, int position) {
        ...
        if (imageUrl != null) {
            ...
            holder.dishImage.setImageResource(R.drawable.rice);
        }
    ...
    public static class DishHomeViewHolder extends RecyclerView.ViewHolder {
        TextView dishName, dishPrice;
        ImageView dishImage;
        ImageButton addToCart;
        LinearLayout detailDishLayout;

        public DishHomeViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            detailDishLayout = itemView.findViewById(R.id.item_dish_detail);
        }
    }
}