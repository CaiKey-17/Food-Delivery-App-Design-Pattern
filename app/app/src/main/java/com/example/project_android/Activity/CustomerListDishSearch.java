...
public class CustomerListDishSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_list_dish_search);

        recyclerView = findViewById(R.id.rec_search_rice);
        recyclerView.setLayoutManager(new LinearLayoutManager(CustomerListDishSearch.this));
        ...
        result_search.setText("Kết quá tìm kiếm: '" + nameDish + "'");
    ...
    private void loadListMenu3() {
        ...
        api.searchDish(nameDish).enqueue(new Callback<List<Dish>>() {
            @Override
    ...
    private void populateListView3(List<Dish> dishes) {
        DishOfGroupAdapter adapter = new DishOfGroupAdapter(CustomerListDishSearch.this, dishes, new OnItemClickListener<Dish>() {
            @Override
            public void onItemClick(Dish item, int position) {
                Intent intent = new Intent(CustomerListDishSearch.this, ShowDetail.class);
