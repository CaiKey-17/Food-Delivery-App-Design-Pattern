...
import com.example.project_android.Utils.DataModelType;
import com.example.project_android.databinding.ActivityCallBinding;
    ...
    private void init() {
        ...
        views.micButton.setOnClickListener(v -> {
            if (isMicrophoneMuted) {
                views.micButton.setImageResource(R.drawable.baseline_mic_off_24);
            } else {
        ...
        views.videoButton.setOnClickListener(v -> {
            if (isCameraMuted) {
                views.videoButton.setImageResource(R.drawable.baseline_videocam_off_24);
            } else {
                views.videoButton.setImageResource(R.drawable.baseline_videocam_24);
            }
